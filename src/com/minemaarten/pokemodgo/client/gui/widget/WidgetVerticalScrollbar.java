...
public class WidgetVerticalScrollbar extends WidgetBase{
    ...
    private static ResourceLocation scrollTexture = new ResourceLocation(Constants.MOD_ID, "textures/gui/scrollbar.png");
    ...
    public void render(int mouseX, int mouseY, float partialTick){
        ...
        if(!enabled) GL11.glColor4d(0.6, 0, 0, 1);
        Gui.drawModalRectWithCustomSizedTexture(x + 1, y + 1 + (int)((getBounds().height - 17) * currentScroll), 0, 0, 8, 15, 26, 15);
